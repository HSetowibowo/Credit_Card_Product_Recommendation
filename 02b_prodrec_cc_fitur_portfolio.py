...
hive_table = "prodrec_cc_fitur_portfolio"
...
if is_proc:
  ...
  df_result = df_userpool\
    ...
    .select(
      ...
      df_casatd_rollup["saving_casa_aktif_count_na"].alias("saving_casa_aktif_count_na"),
      df_casatd_rollup["saving_casa_aktif_sum_na"].alias("saving_casa_aktif_sum_na"),)
